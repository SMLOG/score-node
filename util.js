...
export const kUtil = {
  ...
  adbd: function (t, e, i, n) {
    for (
      var r,
        ...
        o,
        s,
        l = i ? dataUtil.stbdt : dataUtil.stbd,
        u = t.length,
        c = e.length;
      c--;
  ...
  ayd: function (t, e, i, n, r) {
    for (var a, o, s, l, u = dataUtil.stbd, c = t.length, h = e.length; h--; )
      if (((s = e[h]), !(s > r))) {
        if (n > s && !dataUtil.stbd(s, n)) break;
